...
path = 'C:\\Users\\KLA\\Dropbox\\MHC OPS Absent Narratives Approach\\Evaluation (All) 2016-2017\\Data\\Participation Data\\frozen data\\cohort_not_cohort_attended_04182017.csv'
all_data = pd.read_csv(path, encoding = "ISO-8859-1")

partner_path = 'C:\\Users\\KLA\\Dropbox\\MHC OPS Absent Narratives Approach\\Evaluation (All) 2016-2017\\Data\\Partner School\\partners_2016_2017_revised_05042017.csv'
...
for entity_id in partner_ids:
	...
	df.to_csv('C:\\Users\\KLA\\Dropbox\\MHC OPS Absent Narratives Approach\\Evaluation (All) 2016-2017\\Data\\Excel School Profiles\\records_by_entity\\' + str(entity_id) + '.csv')
	...
	leaders_df.to_csv('C:\\Users\\KLA\\Dropbox\\MHC OPS Absent Narratives Approach\\Evaluation (All) 2016-2017\\Data\\Excel School Profiles\\records_by_entity\\' + str(entity_id) + '_leadership.csv')
	...
	individuals_df.to_csv('C:\\Users\\KLA\\Dropbox\\MHC OPS Absent Narratives Approach\\Evaluation (All) 2016-2017\\Data\\Excel School Profiles\\records_by_entity\\' + str(entity_id) + '_individuals.csv')
