...
school_path = 'C:\\Users\\KLA\\Dropbox\\MHC OPS Absent Narratives Approach\\Evaluation (All) 2016-2017\\Data\\School master data\\frozen data\\schools_master_data_11102016.csv'
...
school_df = nesa_df.merge(partner_df, how = 'left', on = ['entity_id', 'school_year'])
'''
...
school_df.to_csv('C:\\Users\\KLA\\Dropbox\\MHC OPS Absent Narratives Approach\\Evaluation (All) 2016-2017\\Data\\NESA data\\working data\\schools_master_data_nesa_' + date + '.csv')
