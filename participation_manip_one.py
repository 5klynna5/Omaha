...
participation_path = 'C:\\Users\KLA\Dropbox\MHC OPS Absent Narratives Approach\Evaluation (All) 2016-2017\Data\School master data\working data\\mhc-ops_participation_all_to_20160614.csv'
...
cohort_df = cohort_df[['person_id', 'full_name', 'position', 'entity_id', 'entity', 'offering_type', 'event_type', 'semester', 'school_year', 'number']]

#len(cohort_df)) 498

cohort_session_df = attended_data.loc[attended_data['event_type'] == 'COHORT SESSION']
cohort_session_df = cohort_session_df[['person_id', 'full_name', 'position', 'entity_id', 'entity', 'offering_type', 'event_type', 'semester', 'school_year', 'number']]
...
not_cohort_df = not_cohort_df[['person_id', 'full_name', 'position', 'entity_id', 'entity', 'offering_type', 'event_type', 'semester', 'school_year', 'number']]
